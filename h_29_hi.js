...
bottomArea.text(171, 270, 'ひ').click(playAud01).attr({
  'font-size': 100,
  'cursor': 'pointer'
});
...
h_hitai.use().transform('t140 415').click(playAud02).appendTo(bottomArea).attr({
  'cursor': 'pointer'
});

var t12 = bottomArea.text(180, 550, ['ひ', 'たい', '이마']).click(playAud02).attr({
  'font-size': 25,
  'cursor': 'pointer'
});
